// Build: g++ ass3_parallel_reduction_interactive.cpp -o ass3_parallel_reduction_interactive -fopenmp
// Run: ./ass3_parallel_reduction_interactive
...
int main() {
    ...
    cout << "\n\n===== EXECUTION TIMES =====\n";
    cout << "\nSequential Sum Time : " << seqSumTime << " sec";
    cout << "\nParallel Sum Time   : " << parSumTime << " sec";

    cout << "\n\nSequential Min Time : " << seqMinTime << " sec";
    cout << "\nParallel Min Time   : " << parMinTime << " sec";

    cout << "\n\nSequential Max Time : " << seqMaxTime << " sec";
    cout << "\nParallel Max Time   : " << parMaxTime << " sec";

    cout << "\n\nSequential Avg Time : " << seqAvgTime << " sec";
    cout << "\nParallel Avg Time   : " << parAvgTime << " sec";
    ...
    if (parSumTime > 0) {
        ...
        cout << "\nThroughput : " << throughput << " elements/sec";
    }
